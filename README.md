...
It's my go-to framework for structuring test suites and managing test dependencies.
☁️ AWS and Docker: </br>
...
Additionally, I'm comfortable with Docker, containerizing applications for consistent testing across environments.</br>
** CI/CD:** Continuous Integration and Continuous Deployment (CI/CD) are my specialty.</br> 
I've integrated test automation into CI/CD pipelines using tools like Jenkins, GitLab CI/CD, and GitHub Actions.</br>
** API Testing:** </br>
I'm proficient in RestAssured for API testing.</br>
Validating endpoints, handling authentication, and verifying response data are all part of my skills.
** Postman:** </br>
I've created comprehensive API test suites using Postman, ensuring API endpoints meet functional requirements and perform optimally.
️ MySQL:</br>
